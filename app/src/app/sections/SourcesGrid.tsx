...
export default function SourcesGrid() {
  return (
    <>
      ...
      <div className="px-[var(--pad-page)] mb-12 overflow-x-auto">
          ...
          {SOURCES.map((s) => (
            ...
            >
              <Card interactive>
                ...
                <div className="text-[11px] text-[var(--text-secondary)] leading-normal mb-2">
                  {s.desc}
                </div>
                <div className="inline-block text-[10px] uppercase tracking-[0.06em] font-semibold px-2 py-[3px] rounded-full bg-[#1a1a1a] text-[var(--text-muted)] border border-[#2a2a2a]">
                  {s.badge}
                </div>
              </Card>
            </Link>
